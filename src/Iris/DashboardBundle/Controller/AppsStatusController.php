...
//           get application type
            ...
            $this->pushNotification('curl --data "AppID=' . $applicationID . '&Type=' . $applicationDetail['Type'] . '&UserName=' . $clientID . '" http://34.212.192.209/IrisCentral/web/app_dev.php/dashboard/command/pushDownloadNotification');
