...
class Developer2Controller extends Controller
{
...
//        $metadata_dir 	= $this->container->getParameter('melodycode_fossdroid.local_path_metadata');
        ...
        return $this->forward("DashboardBundle:Developer2:newApp");
    }
...
public function newAppAction() 
{
		...
		$app_category 			= $request->request->get('app-category');
    		...
    		$stmt = $conn->prepare('INSERT INTO Application (ID,Name,Price,Type) VALUES (?,?,?,"tablet")');
